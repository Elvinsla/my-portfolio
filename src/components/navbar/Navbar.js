        ...
        {showMenu && (
          <div className="w-[80%] h-screen overflow-scroll absolute top-0 left-0 bg-gray-900 p-4 scrollbar-hide">
            <div className="flex flex-col gap-8 py-2 relative">
              <div>
                <h1 className='text-blue-300'>VASANTHKUMAR</h1>
                <p className="text-sm text-gray-400 mt-2">
                Python developer skilled in Django, React, HTML, CSS, SQLite, dedicated to delivering high-quality web applications with solid software development principles.
                </p>
              </div>
